...
class BCData{
	...
	public:
		...
		*/
		...
		void searchIntegralResistanceModularAddition(uint const t, std::string const &  outputFile = "");
		/*
			Try to prove Integral resistance for the block cipher for block cipher construction with modular addition post and pre-whitening
		*/
